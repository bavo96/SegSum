...
if __name__ == "__main__":
    ...
    raw_video_features = pickle.load(
        open(config.features_path, "rb")
    )  # Load features to memory first
    ...
    for seed in range(1, 3000):
        ...
        for split_idx in range(5):
            ...
            solver = Solver(train_config, train_loader, test_loader, split_idx)
    ...
    print(f"Average fscore after 3000 seeds: {np.mean(seed_scores):.2f}%")
